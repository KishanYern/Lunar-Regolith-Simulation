...
Results are written to `results.csv` in the working directory.
...
```
t=5.04s  active=5000  stopped=0  collisions=0  (16%)
```
...
All device memory is allocated once at the start of the simulation via `#pragma omp target data` and released when the block exits. There are no per-timestep host-device transfers except a single 4-byte read of the collision count.
...
```csv
id,diameter,mass,final_x,peak_height,t_start
0,1.510524e-05,4.872424e-12,58770.172286,5478.336700,0.4999
1,1.272784e-04,2.914918e-09,51826.447607,12562.420994,3.2544
```
...
Regolith_Simulation/
  ...
  results.csv          # Output data (generated at runtime)
  README.md            # This file
